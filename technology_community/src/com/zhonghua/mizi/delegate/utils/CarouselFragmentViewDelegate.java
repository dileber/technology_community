...
import com.zhonghua.mizi.utils.carousel.ImageCarouselPageAdapter;
 ...
 */
public class CarouselFragmentViewDelegate  extends AppViewDelegate implements ICarouselView{
    ...
    public View imageViews(String url) {
        ...
        imageView.setImageUrl(url, R.drawable.image_loading);
        return imageView;
    }
}